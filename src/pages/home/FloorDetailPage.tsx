...
import {MOCK_SLOTS, ROOMS_BY_FLOOR, type FloorValue} from '@/pages/home/constants/home';
    ...
    <div className='bg-bg-page flex min-h-dvh flex-col'>
        ...
        <div className='flex items-start justify-between'>
          <div className='flex flex-col gap-3'>
            ...
            <div className='mt-2 inline-grid grid-cols-[34px_auto] items-center gap-x-1.5 gap-y-1.5 rounded-lg bg-white p-2'>
              ...
              <div className='bg-gray-200 h-3.5 w-8.5' />
              <span className='text-[9px] text-text-body'>예약 선택 시</span>
              <div className='bg-secondary h-3.5 w-8.5' />
              <span className='text-[9px] text-text-body'>예약 불가(레슨, 예약됨)</span>
            </div>
          </div>
      ...
      <div className='p-5 pt-0'>
        <button
          ...
          className='bg-action-primary h-12 w-full rounded-xl text-button1 tracking-[0.54px] text-white disabled:opacity-40'>
          예약하기
        </button>
      </div>
    </div>
